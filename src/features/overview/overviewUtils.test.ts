...
describe("calculateMetrics", () => {
  ...
  it("excludes investment contributions from income and expenses", () => {
...
describe("sumInvestments / sumGoalSavings", () => {
  ...
  it("can go negative when withdrawals exceed deposits", () => {
    expect(sumInvestments([investDeposit(100), investWithdrawal(400)])).toBe(-300);
  });
});
