...
import { OverviewPage, TransactionsPage, AnalyticsPage, GoalsPage, SettingsPage, InvestmentsPage, BillsPage, PlannerPage, AllocationPage, DebtsPage, LoginPage, RegisterPage } from "./lazyRoutes";
